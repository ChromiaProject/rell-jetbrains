...
class RellLspRoutingTest : RellVersionAwareTestCase() {
    ...
    fun testNewestDescriptorServesDefaultsAndNewestButNotOldOrCeased() {
        ...
        assertTrue(descriptor.isSupportedFile(rellFile("newest", "0.16.5")))
        assertTrue(
    ...
    fun testVersionedDescriptorRequiresExactVersion() {
        ...
        assertFalse("Wrong version must not match", descriptor.isSupportedFile(rellFile("newest2", "0.16.5")))
    ...
    fun testProviderStartsTheNewestServerForNewestAndDefaultFiles() {
        assertEquals(RellVersionRegistry.max, startedVersionFor(rellFile("p-newest", "0.16.5")))
