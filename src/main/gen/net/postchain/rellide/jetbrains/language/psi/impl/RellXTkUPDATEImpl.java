...
public class RellXTkUPDATEImpl extends ASTWrapperPsiElement implements RellXTkUPDATE {

  public RellXTkUPDATEImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXTkUPDATE(this);
  }
