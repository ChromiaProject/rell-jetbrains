...
public class RellXMirrorStructType0Impl extends ASTWrapperPsiElement implements RellXMirrorStructType0 {

  public RellXMirrorStructType0Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXMirrorStructType0(this);
  }
