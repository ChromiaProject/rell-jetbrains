...
public class RellXGenericTypeImpl extends ASTWrapperPsiElement implements RellXGenericType {

  public RellXGenericTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXGenericType(this);
  }
