...
public class RellXVirtualTypeImpl extends ASTWrapperPsiElement implements RellXVirtualType {

  public RellXVirtualTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXVirtualType(this);
  }
