...
public class RellXTkQUERYImpl extends ASTWrapperPsiElement implements RellXTkQUERY {

  public RellXTkQUERYImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXTkQUERY(this);
  }
