...
public class RellXWhenExprCaseImpl extends ASTWrapperPsiElement implements RellXWhenExprCase {

  public RellXWhenExprCaseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXWhenExprCase(this);
  }
