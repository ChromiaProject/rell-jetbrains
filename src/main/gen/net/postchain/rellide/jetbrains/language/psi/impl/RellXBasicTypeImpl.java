...
public class RellXBasicTypeImpl extends ASTWrapperPsiElement implements RellXBasicType {

  public RellXBasicTypeImpl(@NotNull ASTNode node) {
    super(node);
  }
  ...
  @Override
  @NotNull
  public RellXPrimaryType getXPrimaryType() {
