...
public class RellXWhenExprImpl extends ASTWrapperPsiElement implements RellXWhenExpr {

  public RellXWhenExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXWhenExpr(this);
  }
