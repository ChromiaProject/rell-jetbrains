...
public class RellXBaseExprTailNotNullImpl extends ASTWrapperPsiElement implements RellXBaseExprTailNotNull {

  public RellXBaseExprTailNotNullImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXBaseExprTailNotNull(this);
  }
