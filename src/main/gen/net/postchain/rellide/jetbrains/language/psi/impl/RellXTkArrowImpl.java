...
public class RellXTkArrowImpl extends ASTWrapperPsiElement implements RellXTkArrow {

  public RellXTkArrowImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXTkArrow(this);
  }
