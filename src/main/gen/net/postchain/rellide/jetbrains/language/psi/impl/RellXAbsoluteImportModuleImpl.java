...
public class RellXAbsoluteImportModuleImpl extends ASTWrapperPsiElement implements RellXAbsoluteImportModule {

  public RellXAbsoluteImportModuleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXAbsoluteImportModule(this);
  }
