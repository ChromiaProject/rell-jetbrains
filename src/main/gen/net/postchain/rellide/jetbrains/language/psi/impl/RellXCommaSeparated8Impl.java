...
public class RellXCommaSeparated8Impl extends ASTWrapperPsiElement implements RellXCommaSeparated8 {

  public RellXCommaSeparated8Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXCommaSeparated8(this);
  }
