...
public class RellXModifierImpl extends ASTWrapperPsiElement implements RellXModifier {

  public RellXModifierImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXModifier(this);
  }
  ...
  @Override
  @Nullable
  public RellXAnnotation getXAnnotation() {
