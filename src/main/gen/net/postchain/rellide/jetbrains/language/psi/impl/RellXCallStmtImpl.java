...
public class RellXCallStmtImpl extends ASTWrapperPsiElement implements RellXCallStmt {

  public RellXCallStmtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXCallStmt(this);
  }
