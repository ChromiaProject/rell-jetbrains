...
public class RellXStringExprImpl extends ASTWrapperPsiElement implements RellXStringExpr {

  public RellXStringExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXStringExpr(this);
  }
