...
public class RellXTkDELETEImpl extends ASTWrapperPsiElement implements RellXTkDELETE {

  public RellXTkDELETEImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXTkDELETE(this);
  }
