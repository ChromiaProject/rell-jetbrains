...
public class RellXNameTypeImpl extends ASTWrapperPsiElement implements RellXNameType {

  public RellXNameTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXNameType(this);
  }
