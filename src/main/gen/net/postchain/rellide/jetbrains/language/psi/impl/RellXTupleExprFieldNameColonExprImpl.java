...
public class RellXTupleExprFieldNameColonExprImpl extends ASTWrapperPsiElement implements RellXTupleExprFieldNameColonExpr {

  public RellXTupleExprFieldNameColonExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXTupleExprFieldNameColonExpr(this);
  }
