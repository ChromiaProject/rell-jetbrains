...
public class RellXTupleExprFieldExprImpl extends ASTWrapperPsiElement implements RellXTupleExprFieldExpr {

  public RellXTupleExprFieldExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXTupleExprFieldExpr(this);
  }
