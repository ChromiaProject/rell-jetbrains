...
public class RellXTupleTypeFieldImpl extends ASTWrapperPsiElement implements RellXTupleTypeField {

  public RellXTupleTypeFieldImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXTupleTypeField(this);
  }
