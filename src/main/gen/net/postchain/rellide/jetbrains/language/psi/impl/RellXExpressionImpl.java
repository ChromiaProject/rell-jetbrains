...
public class RellXExpressionImpl extends ASTWrapperPsiElement implements RellXExpression {

  public RellXExpressionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXExpression(this);
  }
  ...
  @Override
  @NotNull
  public List<RellXBinaryExprOperand> getXBinaryExprOperandList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, RellXBinaryExprOperand.class);
  }
