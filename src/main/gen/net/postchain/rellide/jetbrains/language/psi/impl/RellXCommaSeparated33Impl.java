...
public class RellXCommaSeparated33Impl extends ASTWrapperPsiElement implements RellXCommaSeparated33 {

  public RellXCommaSeparated33Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXCommaSeparated33(this);
  }
