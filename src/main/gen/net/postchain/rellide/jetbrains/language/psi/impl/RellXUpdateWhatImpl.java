...
public class RellXUpdateWhatImpl extends ASTWrapperPsiElement implements RellXUpdateWhat {

  public RellXUpdateWhatImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXUpdateWhat(this);
  }
  ...
  @Override
  @NotNull
  public RellXCommaSeparated34 getXCommaSeparated34() {
    return findNotNullChildByClass(RellXCommaSeparated34.class);
  }
