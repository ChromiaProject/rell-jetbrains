...
public class RellXCommaSeparated11Impl extends ASTWrapperPsiElement implements RellXCommaSeparated11 {

  public RellXCommaSeparated11Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXCommaSeparated11(this);
  }
