...
public class RellXWhenExprCasesImpl extends ASTWrapperPsiElement implements RellXWhenExprCases {

  public RellXWhenExprCasesImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXWhenExprCases(this);
  }
