...
public class RellXFunctionBodyShortImpl extends ASTWrapperPsiElement implements RellXFunctionBodyShort {

  public RellXFunctionBodyShortImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXFunctionBodyShort(this);
  }
