...
public class RellXCommaSeparated31Impl extends ASTWrapperPsiElement implements RellXCommaSeparated31 {

  public RellXCommaSeparated31Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXCommaSeparated31(this);
  }
