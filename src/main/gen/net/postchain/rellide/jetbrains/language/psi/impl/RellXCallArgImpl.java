...
public class RellXCallArgImpl extends ASTWrapperPsiElement implements RellXCallArg {

  public RellXCallArgImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXCallArg(this);
  }
