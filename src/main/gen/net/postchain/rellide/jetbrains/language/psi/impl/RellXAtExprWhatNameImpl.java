...
public class RellXAtExprWhatNameImpl extends ASTWrapperPsiElement implements RellXAtExprWhatName {

  public RellXAtExprWhatNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXAtExprWhatName(this);
  }
