...
public class RellXComplexNullableTypeImpl extends ASTWrapperPsiElement implements RellXComplexNullableType {

  public RellXComplexNullableTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXComplexNullableType(this);
  }
