...
public class RellXTkCOMMAImpl extends ASTWrapperPsiElement implements RellXTkCOMMA {

  public RellXTkCOMMAImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXTkCOMMA(this);
  }
