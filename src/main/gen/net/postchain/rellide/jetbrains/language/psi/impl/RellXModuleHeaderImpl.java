...
public class RellXModuleHeaderImpl extends ASTWrapperPsiElement implements RellXModuleHeader {

  public RellXModuleHeaderImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXModuleHeader(this);
  }
  ...
  @Override
  @NotNull
  public RellXTkMODULE getXTkMODULE() {
    return findNotNullChildByClass(RellXTkMODULE.class);
  }
