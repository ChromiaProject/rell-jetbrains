...
public class RellXCommaSeparated23Impl extends ASTWrapperPsiElement implements RellXCommaSeparated23 {

  public RellXCommaSeparated23Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXCommaSeparated23(this);
  }
