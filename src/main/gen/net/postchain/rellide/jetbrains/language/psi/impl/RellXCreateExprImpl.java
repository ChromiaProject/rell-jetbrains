...
public class RellXCreateExprImpl extends ASTWrapperPsiElement implements RellXCreateExpr {

  public RellXCreateExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXCreateExpr(this);
  }
