...
public class RellXCallArgValueImpl extends ASTWrapperPsiElement implements RellXCallArgValue {

  public RellXCallArgValueImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXCallArgValue(this);
  }
