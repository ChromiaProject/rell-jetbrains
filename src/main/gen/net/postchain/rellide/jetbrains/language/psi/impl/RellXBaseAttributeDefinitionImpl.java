...
public class RellXBaseAttributeDefinitionImpl extends ASTWrapperPsiElement implements RellXBaseAttributeDefinition {

  public RellXBaseAttributeDefinitionImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXBaseAttributeDefinition(this);
  }
  ...
  @Override
  @NotNull
  public RellXAttrHeader getXAttrHeader() {
    return findNotNullChildByClass(RellXAttrHeader.class);
  }
