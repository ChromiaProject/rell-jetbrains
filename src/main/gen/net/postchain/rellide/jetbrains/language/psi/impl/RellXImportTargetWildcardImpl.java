...
public class RellXImportTargetWildcardImpl extends ASTWrapperPsiElement implements RellXImportTargetWildcard {

  public RellXImportTargetWildcardImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXImportTargetWildcard(this);
  }
