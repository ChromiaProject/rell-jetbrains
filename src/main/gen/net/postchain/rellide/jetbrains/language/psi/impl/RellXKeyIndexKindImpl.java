...
public class RellXKeyIndexKindImpl extends ASTWrapperPsiElement implements RellXKeyIndexKind {

  public RellXKeyIndexKindImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXKeyIndexKind(this);
  }
