...
public class RellXAnnotatedDefImpl extends ASTWrapperPsiElement implements RellXAnnotatedDef {

  public RellXAnnotatedDefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXAnnotatedDef(this);
  }
  ...
  @Override
  @NotNull
  public RellXAnyDef getXAnyDef() {
    return findNotNullChildByClass(RellXAnyDef.class);
  }
