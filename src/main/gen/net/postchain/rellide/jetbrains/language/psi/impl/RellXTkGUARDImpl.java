...
public class RellXTkGUARDImpl extends ASTWrapperPsiElement implements RellXTkGUARD {

  public RellXTkGUARDImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXTkGUARD(this);
  }
