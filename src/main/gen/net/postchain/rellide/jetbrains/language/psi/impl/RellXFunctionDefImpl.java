...
public class RellXFunctionDefImpl extends ASTWrapperPsiElement implements RellXFunctionDef {

  public RellXFunctionDefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXFunctionDef(this);
  }
  ...
  @Override
  @NotNull
  public RellXFunctionBody getXFunctionBody() {
    return findNotNullChildByClass(RellXFunctionBody.class);
  }
