...
public class RellXCreateExprArgImpl extends ASTWrapperPsiElement implements RellXCreateExprArg {

  public RellXCreateExprArgImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXCreateExprArg(this);
  }
  ...
  @Override
  @NotNull
  public RellXCallArgValue getXCallArgValue() {
    return findNotNullChildByClass(RellXCallArgValue.class);
  }
