...
public class RellXUnaryPostfixOperatorImpl extends ASTWrapperPsiElement implements RellXUnaryPostfixOperator {

  public RellXUnaryPostfixOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXUnaryPostfixOperator(this);
  }
