...
public class RellXCommaSeparated35Impl extends ASTWrapperPsiElement implements RellXCommaSeparated35 {

  public RellXCommaSeparated35Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXCommaSeparated35(this);
  }
