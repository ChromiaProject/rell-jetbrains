...
public class RellXBigIntExprImpl extends ASTWrapperPsiElement implements RellXBigIntExpr {

  public RellXBigIntExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXBigIntExpr(this);
  }
  ...
  @Override
  @NotNull
  public RellBigInteger getBigInteger() {
    return findNotNullChildByClass(RellBigInteger.class);
  }
