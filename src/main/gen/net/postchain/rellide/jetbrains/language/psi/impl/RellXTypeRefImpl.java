...
public class RellXTypeRefImpl extends ASTWrapperPsiElement implements RellXTypeRef {

  public RellXTypeRefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXTypeRef(this);
  }
