...
public class RellXCommaSeparated9Impl extends ASTWrapperPsiElement implements RellXCommaSeparated9 {

  public RellXCommaSeparated9Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXCommaSeparated9(this);
  }
