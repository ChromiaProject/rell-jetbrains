...
public class RellXWhenConditionElseImpl extends ASTWrapperPsiElement implements RellXWhenConditionElse {

  public RellXWhenConditionElseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXWhenConditionElse(this);
  }
