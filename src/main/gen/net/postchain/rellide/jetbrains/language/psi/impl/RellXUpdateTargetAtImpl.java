...
public class RellXUpdateTargetAtImpl extends ASTWrapperPsiElement implements RellXUpdateTargetAt {

  public RellXUpdateTargetAtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXUpdateTargetAt(this);
  }
