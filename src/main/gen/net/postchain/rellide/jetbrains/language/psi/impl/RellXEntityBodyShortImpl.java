...
public class RellXEntityBodyShortImpl extends ASTWrapperPsiElement implements RellXEntityBodyShort {

  public RellXEntityBodyShortImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXEntityBodyShort(this);
  }
