...
public class RellXBaseExprTailCallImpl extends ASTWrapperPsiElement implements RellXBaseExprTailCall {

  public RellXBaseExprTailCallImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXBaseExprTailCall(this);
  }
  ...
  @Override
  @NotNull
  public RellXCallArgs getXCallArgs() {
    return findNotNullChildByClass(RellXCallArgs.class);
  }
