...
public class RellXFunctionBodyFullImpl extends ASTWrapperPsiElement implements RellXFunctionBodyFull {

  public RellXFunctionBodyFullImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXFunctionBodyFull(this);
  }
