...
public class RellXTupleExprImpl extends ASTWrapperPsiElement implements RellXTupleExpr {

  public RellXTupleExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXTupleExpr(this);
  }
  ...
  @Override
  @NotNull
  public RellXCommaSeparated14 getXCommaSeparated14() {
    return findNotNullChildByClass(RellXCommaSeparated14.class);
  }
