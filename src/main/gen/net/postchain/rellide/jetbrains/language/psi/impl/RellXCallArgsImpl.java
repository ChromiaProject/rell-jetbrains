...
public class RellXCallArgsImpl extends ASTWrapperPsiElement implements RellXCallArgs {

  public RellXCallArgsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXCallArgs(this);
  }
