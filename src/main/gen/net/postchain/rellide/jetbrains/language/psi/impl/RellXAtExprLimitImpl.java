...
public class RellXAtExprLimitImpl extends ASTWrapperPsiElement implements RellXAtExprLimit {

  public RellXAtExprLimitImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXAtExprLimit(this);
  }
