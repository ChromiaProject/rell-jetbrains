...
public class RellXTkLBRACKImpl extends ASTWrapperPsiElement implements RellXTkLBRACK {

  public RellXTkLBRACKImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXTkLBRACK(this);
  }
