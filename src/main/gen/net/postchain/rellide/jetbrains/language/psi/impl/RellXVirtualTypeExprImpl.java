...
public class RellXVirtualTypeExprImpl extends ASTWrapperPsiElement implements RellXVirtualTypeExpr {

  public RellXVirtualTypeExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXVirtualTypeExpr(this);
  }
  ...
  public RellXVirtualType getXVirtualType() {
    return findNotNullChildByClass(RellXVirtualType.class);
  }
