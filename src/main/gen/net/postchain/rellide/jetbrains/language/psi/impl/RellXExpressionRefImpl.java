...
public class RellXExpressionRefImpl extends ASTWrapperPsiElement implements RellXExpressionRef {

  public RellXExpressionRefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXExpressionRef(this);
  }
