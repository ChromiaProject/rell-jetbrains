...
public class RellXUpdateFromSingleImpl extends ASTWrapperPsiElement implements RellXUpdateFromSingle {

  public RellXUpdateFromSingleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXUpdateFromSingle(this);
  }
