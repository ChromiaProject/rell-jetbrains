...
public class RellXFormalParameterImpl extends ASTWrapperPsiElement implements RellXFormalParameter {

  public RellXFormalParameterImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXFormalParameter(this);
  }
