...
public class RellXCommaSeparated2Impl extends ASTWrapperPsiElement implements RellXCommaSeparated2 {

  public RellXCommaSeparated2Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXCommaSeparated2(this);
  }
