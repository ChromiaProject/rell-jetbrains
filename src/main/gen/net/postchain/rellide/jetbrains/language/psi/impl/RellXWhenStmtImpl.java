...
public class RellXWhenStmtImpl extends ASTWrapperPsiElement implements RellXWhenStmt {

  public RellXWhenStmtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXWhenStmt(this);
  }
  ...
  @Override
  @NotNull
  public List<RellXWhenStmtCase> getXWhenStmtCaseList() {
