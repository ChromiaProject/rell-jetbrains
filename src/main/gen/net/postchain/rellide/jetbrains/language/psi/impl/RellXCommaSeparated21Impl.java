...
public class RellXCommaSeparated21Impl extends ASTWrapperPsiElement implements RellXCommaSeparated21 {

  public RellXCommaSeparated21Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXCommaSeparated21(this);
  }
