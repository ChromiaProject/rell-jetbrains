...
public class RellXAtExprWhereImpl extends ASTWrapperPsiElement implements RellXAtExprWhere {

  public RellXAtExprWhereImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXAtExprWhere(this);
  }
