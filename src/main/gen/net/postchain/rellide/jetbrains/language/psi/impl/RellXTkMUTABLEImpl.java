...
public class RellXTkMUTABLEImpl extends ASTWrapperPsiElement implements RellXTkMUTABLE {

  public RellXTkMUTABLEImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXTkMUTABLE(this);
  }
