...
public class RellXContinueStmtImpl extends ASTWrapperPsiElement implements RellXContinueStmt {

  public RellXContinueStmtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXContinueStmt(this);
  }
