...
public class RellXStructKeywordImpl extends ASTWrapperPsiElement implements RellXStructKeyword {

  public RellXStructKeywordImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXStructKeyword(this);
  }
