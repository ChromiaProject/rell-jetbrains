...
public class RellXTkVIRTUALImpl extends ASTWrapperPsiElement implements RellXTkVIRTUAL {

  public RellXTkVIRTUALImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXTkVIRTUAL(this);
  }
