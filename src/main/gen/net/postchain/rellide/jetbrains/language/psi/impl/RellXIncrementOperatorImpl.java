...
public class RellXIncrementOperatorImpl extends ASTWrapperPsiElement implements RellXIncrementOperator {

  public RellXIncrementOperatorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXIncrementOperator(this);
  }
