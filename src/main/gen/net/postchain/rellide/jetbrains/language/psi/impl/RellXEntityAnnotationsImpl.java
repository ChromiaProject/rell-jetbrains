...
public class RellXEntityAnnotationsImpl extends ASTWrapperPsiElement implements RellXEntityAnnotations {

  public RellXEntityAnnotationsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXEntityAnnotations(this);
  }
