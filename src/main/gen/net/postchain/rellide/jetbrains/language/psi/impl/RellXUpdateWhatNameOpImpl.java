...
public class RellXUpdateWhatNameOpImpl extends ASTWrapperPsiElement implements RellXUpdateWhatNameOp {

  public RellXUpdateWhatNameOpImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXUpdateWhatNameOp(this);
  }
