...
public class RellXTkCARETImpl extends ASTWrapperPsiElement implements RellXTkCARET {

  public RellXTkCARETImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXTkCARET(this);
  }
