...
public class RellXAnnotationArgsImpl extends ASTWrapperPsiElement implements RellXAnnotationArgs {

  public RellXAnnotationArgsImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXAnnotationArgs(this);
  }
