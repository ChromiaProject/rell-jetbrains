...
public class RellXTupleTypeImpl extends ASTWrapperPsiElement implements RellXTupleType {

  public RellXTupleTypeImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXTupleType(this);
  }
