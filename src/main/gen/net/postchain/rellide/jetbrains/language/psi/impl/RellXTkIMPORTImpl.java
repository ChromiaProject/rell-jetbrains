...
public class RellXTkIMPORTImpl extends ASTWrapperPsiElement implements RellXTkIMPORT {

  public RellXTkIMPORTImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXTkIMPORT(this);
  }
