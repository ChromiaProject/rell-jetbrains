...
public class RellXTupleExprFieldImpl extends ASTWrapperPsiElement implements RellXTupleExprField {

  public RellXTupleExprFieldImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXTupleExprField(this);
  }
