...
public class RellXBaseExprTailMemberImpl extends ASTWrapperPsiElement implements RellXBaseExprTailMember {

  public RellXBaseExprTailMemberImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXBaseExprTailMember(this);
  }
