...
public class RellXTkBREAKImpl extends ASTWrapperPsiElement implements RellXTkBREAK {

  public RellXTkBREAKImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXTkBREAK(this);
  }
