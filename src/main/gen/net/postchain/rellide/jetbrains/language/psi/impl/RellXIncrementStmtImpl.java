...
public class RellXIncrementStmtImpl extends ASTWrapperPsiElement implements RellXIncrementStmt {

  public RellXIncrementStmtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXIncrementStmt(this);
  }
  ...
  public RellXIncrementOperator getXIncrementOperator() {
    return findNotNullChildByClass(RellXIncrementOperator.class);
  }
