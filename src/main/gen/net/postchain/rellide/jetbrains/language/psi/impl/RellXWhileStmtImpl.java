...
public class RellXWhileStmtImpl extends ASTWrapperPsiElement implements RellXWhileStmt {

  public RellXWhileStmtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXWhileStmt(this);
  }
