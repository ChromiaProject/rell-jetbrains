...
public class RellXAnnotationArgNameImpl extends ASTWrapperPsiElement implements RellXAnnotationArgName {

  public RellXAnnotationArgNameImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXAnnotationArgName(this);
  }
