...
public class RellXMapLiteralExprEntryImpl extends ASTWrapperPsiElement implements RellXMapLiteralExprEntry {

  public RellXMapLiteralExprEntryImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXMapLiteralExprEntry(this);
  }
