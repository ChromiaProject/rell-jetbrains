...
public class RellXUpdateWhatExprImpl extends ASTWrapperPsiElement implements RellXUpdateWhatExpr {

  public RellXUpdateWhatExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXUpdateWhatExpr(this);
  }
  ...
  @Override
  @Nullable
  public RellXUpdateWhatNameOp getXUpdateWhatNameOp() {
    return findChildByClass(RellXUpdateWhatNameOp.class);
  }
