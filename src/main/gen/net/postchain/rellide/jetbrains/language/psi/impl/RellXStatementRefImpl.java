...
public class RellXStatementRefImpl extends ASTWrapperPsiElement implements RellXStatementRef {

  public RellXStatementRefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXStatementRef(this);
  }
  ...
  @Override
  @NotNull
  public RellXStatement getXStatement() {
    return findNotNullChildByClass(RellXStatement.class);
  }
