...
public class RellXBytesExprImpl extends ASTWrapperPsiElement implements RellXBytesExpr {

  public RellXBytesExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXBytesExpr(this);
  }
  ...
  public PsiElement getBytes() {
    return findNotNullChildByType(BYTES);
  }
