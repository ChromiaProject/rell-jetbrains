...
public class RellXUpdateFromItemImpl extends ASTWrapperPsiElement implements RellXUpdateFromItem {

  public RellXUpdateFromItemImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXUpdateFromItem(this);
  }
