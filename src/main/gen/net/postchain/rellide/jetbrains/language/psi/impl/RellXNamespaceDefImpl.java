...
public class RellXNamespaceDefImpl extends ASTWrapperPsiElement implements RellXNamespaceDef {

  public RellXNamespaceDefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXNamespaceDef(this);
  }
  ...
  @Override
  @NotNull
  public List<RellXAnnotatedDef> getXAnnotatedDefList() {
    return PsiTreeUtil.getChildrenOfTypeAsList(this, RellXAnnotatedDef.class);
  }
