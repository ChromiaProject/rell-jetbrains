...
public class RellXTkSTRUCTImpl extends ASTWrapperPsiElement implements RellXTkSTRUCT {

  public RellXTkSTRUCTImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXTkSTRUCT(this);
  }
