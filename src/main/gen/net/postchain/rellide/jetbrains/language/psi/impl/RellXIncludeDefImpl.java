...
public class RellXIncludeDefImpl extends ASTWrapperPsiElement implements RellXIncludeDef {

  public RellXIncludeDefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXIncludeDef(this);
  }
