...
public class RellXTkWHILEImpl extends ASTWrapperPsiElement implements RellXTkWHILE {

  public RellXTkWHILEImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXTkWHILE(this);
  }
