...
public class RellXTupleVarDeclaratorImpl extends ASTWrapperPsiElement implements RellXTupleVarDeclarator {

  public RellXTupleVarDeclaratorImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXTupleVarDeclarator(this);
  }
