...
public class RellXCommaSeparated7Impl extends ASTWrapperPsiElement implements RellXCommaSeparated7 {

  public RellXCommaSeparated7Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXCommaSeparated7(this);
  }
  ...
  @Override
  @Nullable
  public RellXCommaSeparated6 getXCommaSeparated6() {
    return findChildByClass(RellXCommaSeparated6.class);
  }
