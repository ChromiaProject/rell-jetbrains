...
public class RellXTkNAMESPACEImpl extends ASTWrapperPsiElement implements RellXTkNAMESPACE {

  public RellXTkNAMESPACEImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXTkNAMESPACE(this);
  }
