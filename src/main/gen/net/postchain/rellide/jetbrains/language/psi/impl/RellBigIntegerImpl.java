...
public class RellBigIntegerImpl extends ASTWrapperPsiElement implements RellBigInteger {

  public RellBigIntegerImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitBigInteger(this);
  }
  ...
  @Override
  @NotNull
  public RellCommonInt getCommonInt() {
    return findNotNullChildByClass(RellCommonInt.class);
  }
