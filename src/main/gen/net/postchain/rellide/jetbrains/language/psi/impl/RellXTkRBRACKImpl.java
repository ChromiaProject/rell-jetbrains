...
public class RellXTkRBRACKImpl extends ASTWrapperPsiElement implements RellXTkRBRACK {

  public RellXTkRBRACKImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXTkRBRACK(this);
  }
