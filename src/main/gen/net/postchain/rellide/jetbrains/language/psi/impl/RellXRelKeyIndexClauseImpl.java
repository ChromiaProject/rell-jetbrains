...
public class RellXRelKeyIndexClauseImpl extends ASTWrapperPsiElement implements RellXRelKeyIndexClause {

  public RellXRelKeyIndexClauseImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXRelKeyIndexClause(this);
  }
  ...
  @Override
  @NotNull
  public RellXKeyIndexKind getXKeyIndexKind() {
    return findNotNullChildByClass(RellXKeyIndexKind.class);
  }
