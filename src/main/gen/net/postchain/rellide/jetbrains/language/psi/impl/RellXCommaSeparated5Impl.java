...
public class RellXCommaSeparated5Impl extends ASTWrapperPsiElement implements RellXCommaSeparated5 {

  public RellXCommaSeparated5Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXCommaSeparated5(this);
  }
  ...
  @Override
  @Nullable
  public RellXCommaSeparated4 getXCommaSeparated4() {
    return findChildByClass(RellXCommaSeparated4.class);
  }
