...
public class RellXUpImportModuleImpl extends ASTWrapperPsiElement implements RellXUpImportModule {

  public RellXUpImportModuleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXUpImportModule(this);
  }
