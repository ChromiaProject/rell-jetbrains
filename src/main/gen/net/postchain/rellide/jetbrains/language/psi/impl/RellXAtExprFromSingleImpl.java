...
public class RellXAtExprFromSingleImpl extends ASTWrapperPsiElement implements RellXAtExprFromSingle {

  public RellXAtExprFromSingleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXAtExprFromSingle(this);
  }
