...
public class RellXEmptyMapLiteralExprImpl extends ASTWrapperPsiElement implements RellXEmptyMapLiteralExpr {

  public RellXEmptyMapLiteralExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXEmptyMapLiteralExpr(this);
  }
