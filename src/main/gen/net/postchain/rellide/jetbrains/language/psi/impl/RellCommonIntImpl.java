...
public class RellCommonIntImpl extends ASTWrapperPsiElement implements RellCommonInt {

  public RellCommonIntImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitCommonInt(this);
  }
