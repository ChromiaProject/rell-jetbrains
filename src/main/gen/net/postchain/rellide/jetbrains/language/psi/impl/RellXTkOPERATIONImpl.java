...
public class RellXTkOPERATIONImpl extends ASTWrapperPsiElement implements RellXTkOPERATION {

  public RellXTkOPERATIONImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXTkOPERATION(this);
  }
