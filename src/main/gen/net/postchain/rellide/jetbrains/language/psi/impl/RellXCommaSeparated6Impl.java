...
public class RellXCommaSeparated6Impl extends ASTWrapperPsiElement implements RellXCommaSeparated6 {

  public RellXCommaSeparated6Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXCommaSeparated6(this);
  }
