...
public class RellXEntityKeywordImpl extends ASTWrapperPsiElement implements RellXEntityKeyword {

  public RellXEntityKeywordImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXEntityKeyword(this);
  }
