...
public class RellXTkFUNCTIONImpl extends ASTWrapperPsiElement implements RellXTkFUNCTION {

  public RellXTkFUNCTIONImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXTkFUNCTION(this);
  }
