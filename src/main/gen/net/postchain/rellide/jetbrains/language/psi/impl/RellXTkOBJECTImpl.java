...
public class RellXTkOBJECTImpl extends ASTWrapperPsiElement implements RellXTkOBJECT {

  public RellXTkOBJECTImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXTkOBJECT(this);
  }
