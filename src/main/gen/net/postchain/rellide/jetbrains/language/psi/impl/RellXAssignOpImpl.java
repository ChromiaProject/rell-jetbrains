...
public class RellXAssignOpImpl extends ASTWrapperPsiElement implements RellXAssignOp {

  public RellXAssignOpImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXAssignOp(this);
  }
