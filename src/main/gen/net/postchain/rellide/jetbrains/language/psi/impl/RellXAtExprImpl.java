...
public class RellXAtExprImpl extends ASTWrapperPsiElement implements RellXAtExpr {

  public RellXAtExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXAtExpr(this);
  }
  ...
  public RellXBaseExprTailAt getXBaseExprTailAt() {
    return findNotNullChildByClass(RellXBaseExprTailAt.class);
  }
