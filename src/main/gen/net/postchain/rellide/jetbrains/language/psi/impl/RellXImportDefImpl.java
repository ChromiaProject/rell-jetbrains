...
public class RellXImportDefImpl extends ASTWrapperPsiElement implements RellXImportDef {

  public RellXImportDefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXImportDef(this);
  }
  ...
  @Override
  @NotNull
  public RellXImportModule getXImportModule() {
    return findNotNullChildByClass(RellXImportModule.class);
  }

  @Override
  @Nullable
  public RellXImportTarget getXImportTarget() {
    return findChildByClass(RellXImportTarget.class);
  }
