...
public class RellXTkINCLUDEImpl extends ASTWrapperPsiElement implements RellXTkINCLUDE {

  public RellXTkINCLUDEImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXTkINCLUDE(this);
  }
