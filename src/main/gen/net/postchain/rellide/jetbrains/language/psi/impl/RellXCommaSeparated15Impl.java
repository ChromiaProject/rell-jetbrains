...
public class RellXCommaSeparated15Impl extends ASTWrapperPsiElement implements RellXCommaSeparated15 {

  public RellXCommaSeparated15Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXCommaSeparated15(this);
  }
