...
public class RellXEntityBodyFullImpl extends ASTWrapperPsiElement implements RellXEntityBodyFull {

  public RellXEntityBodyFullImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXEntityBodyFull(this);
  }
