...
public class RellXTkCREATEImpl extends ASTWrapperPsiElement implements RellXTkCREATE {

  public RellXTkCREATEImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXTkCREATE(this);
  }
