...
public class RellXFunctionBodyNoneImpl extends ASTWrapperPsiElement implements RellXFunctionBodyNone {

  public RellXFunctionBodyNoneImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXFunctionBodyNone(this);
  }
