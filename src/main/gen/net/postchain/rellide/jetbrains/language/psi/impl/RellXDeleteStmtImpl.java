...
public class RellXDeleteStmtImpl extends ASTWrapperPsiElement implements RellXDeleteStmt {

  public RellXDeleteStmtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXDeleteStmt(this);
  }
