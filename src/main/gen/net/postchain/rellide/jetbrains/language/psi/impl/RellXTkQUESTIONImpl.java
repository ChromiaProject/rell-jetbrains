...
public class RellXTkQUESTIONImpl extends ASTWrapperPsiElement implements RellXTkQUESTION {

  public RellXTkQUESTIONImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXTkQUESTION(this);
  }
