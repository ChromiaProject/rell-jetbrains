...
public class RellXEmptyStmtImpl extends ASTWrapperPsiElement implements RellXEmptyStmt {

  public RellXEmptyStmtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXEmptyStmt(this);
  }
