...
public class RellXReturnStmtImpl extends ASTWrapperPsiElement implements RellXReturnStmt {

  public RellXReturnStmtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXReturnStmt(this);
  }
