...
public class RellXIntExprImpl extends ASTWrapperPsiElement implements RellXIntExpr {

  public RellXIntExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXIntExpr(this);
  }
  ...
  @Override
  @NotNull
  public RellNumber getNumber() {
    return findNotNullChildByClass(RellNumber.class);
  }
