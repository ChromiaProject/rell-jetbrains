...
public class RellXBaseExprTailSafeMemberImpl extends ASTWrapperPsiElement implements RellXBaseExprTailSafeMember {

  public RellXBaseExprTailSafeMemberImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXBaseExprTailSafeMember(this);
  }
