...
public class RellXTkSTRINGImpl extends ASTWrapperPsiElement implements RellXTkSTRING {

  public RellXTkSTRINGImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXTkSTRING(this);
  }
