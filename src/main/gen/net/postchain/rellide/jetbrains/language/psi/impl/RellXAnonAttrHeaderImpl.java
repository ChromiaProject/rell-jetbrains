...
public class RellXAnonAttrHeaderImpl extends ASTWrapperPsiElement implements RellXAnonAttrHeader {

  public RellXAnonAttrHeaderImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXAnonAttrHeader(this);
  }
