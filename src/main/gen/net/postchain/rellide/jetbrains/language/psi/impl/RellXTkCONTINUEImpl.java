...
public class RellXTkCONTINUEImpl extends ASTWrapperPsiElement implements RellXTkCONTINUE {

  public RellXTkCONTINUEImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXTkCONTINUE(this);
  }
