...
public class RellXAtExprAtImpl extends ASTWrapperPsiElement implements RellXAtExprAt {

  public RellXAtExprAtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXAtExprAt(this);
  }
