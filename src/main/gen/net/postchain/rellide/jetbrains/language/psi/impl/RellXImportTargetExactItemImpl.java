...
public class RellXImportTargetExactItemImpl extends ASTWrapperPsiElement implements RellXImportTargetExactItem {

  public RellXImportTargetExactItemImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXImportTargetExactItem(this);
  }
