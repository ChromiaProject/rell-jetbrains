...
public class RellXTkRETURNImpl extends ASTWrapperPsiElement implements RellXTkRETURN {

  public RellXTkRETURNImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXTkRETURN(this);
  }
