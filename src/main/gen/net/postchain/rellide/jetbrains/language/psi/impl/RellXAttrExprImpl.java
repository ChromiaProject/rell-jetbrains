...
public class RellXAttrExprImpl extends ASTWrapperPsiElement implements RellXAttrExpr {

  public RellXAttrExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXAttrExpr(this);
  }
