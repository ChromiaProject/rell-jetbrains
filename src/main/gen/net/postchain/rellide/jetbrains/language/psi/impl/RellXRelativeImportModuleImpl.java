...
public class RellXRelativeImportModuleImpl extends ASTWrapperPsiElement implements RellXRelativeImportModule {

  public RellXRelativeImportModuleImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXRelativeImportModule(this);
  }
