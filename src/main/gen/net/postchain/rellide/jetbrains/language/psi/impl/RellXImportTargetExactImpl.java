...
public class RellXImportTargetExactImpl extends ASTWrapperPsiElement implements RellXImportTargetExact {

  public RellXImportTargetExactImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXImportTargetExact(this);
  }
