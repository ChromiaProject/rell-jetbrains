...
public class RellXTupleExprFieldNameEqExprImpl extends ASTWrapperPsiElement implements RellXTupleExprFieldNameEqExpr {

  public RellXTupleExprFieldNameEqExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXTupleExprFieldNameEqExpr(this);
  }
