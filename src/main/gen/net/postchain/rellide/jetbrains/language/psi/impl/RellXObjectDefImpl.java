...
public class RellXObjectDefImpl extends ASTWrapperPsiElement implements RellXObjectDef {

  public RellXObjectDefImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXObjectDef(this);
  }
