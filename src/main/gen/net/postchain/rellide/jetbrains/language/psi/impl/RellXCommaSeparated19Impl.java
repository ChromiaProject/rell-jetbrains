...
public class RellXCommaSeparated19Impl extends ASTWrapperPsiElement implements RellXCommaSeparated19 {

  public RellXCommaSeparated19Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXCommaSeparated19(this);
  }
