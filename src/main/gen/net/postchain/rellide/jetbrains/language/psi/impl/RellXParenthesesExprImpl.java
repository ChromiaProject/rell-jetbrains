...
public class RellXParenthesesExprImpl extends ASTWrapperPsiElement implements RellXParenthesesExpr {

  public RellXParenthesesExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXParenthesesExpr(this);
  }
  ...
  @Override
  @NotNull
  public RellXTupleExprField getXTupleExprField() {
    return findNotNullChildByClass(RellXTupleExprField.class);
  }

  @Override
  @Nullable
  public RellXTupleExprTail getXTupleExprTail() {
