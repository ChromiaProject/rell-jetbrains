...
public class RellXListLiteralExprImpl extends ASTWrapperPsiElement implements RellXListLiteralExpr {

  public RellXListLiteralExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXListLiteralExpr(this);
  }
