...
public class RellXCommaSeparated27Impl extends ASTWrapperPsiElement implements RellXCommaSeparated27 {

  public RellXCommaSeparated27Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXCommaSeparated27(this);
  }
