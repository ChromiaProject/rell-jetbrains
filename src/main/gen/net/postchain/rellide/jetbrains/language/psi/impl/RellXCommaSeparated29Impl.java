...
public class RellXCommaSeparated29Impl extends ASTWrapperPsiElement implements RellXCommaSeparated29 {

  public RellXCommaSeparated29Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXCommaSeparated29(this);
  }
