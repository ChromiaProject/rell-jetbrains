...
public class RellXAtExprFromImpl extends ASTWrapperPsiElement implements RellXAtExprFrom {

  public RellXAtExprFromImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXAtExprFrom(this);
  }
  ...
  @Override
  @NotNull
  public RellXCommaSeparated16 getXCommaSeparated16() {
    return findNotNullChildByClass(RellXCommaSeparated16.class);
  }
