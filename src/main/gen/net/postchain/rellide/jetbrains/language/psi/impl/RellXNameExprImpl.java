...
public class RellXNameExprImpl extends ASTWrapperPsiElement implements RellXNameExpr {

  public RellXNameExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXNameExpr(this);
  }
