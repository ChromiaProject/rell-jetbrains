...
public class RellXTkLCURLImpl extends ASTWrapperPsiElement implements RellXTkLCURL {

  public RellXTkLCURLImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXTkLCURL(this);
  }
