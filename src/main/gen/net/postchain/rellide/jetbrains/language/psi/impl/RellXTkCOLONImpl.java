...
public class RellXTkCOLONImpl extends ASTWrapperPsiElement implements RellXTkCOLON {

  public RellXTkCOLONImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXTkCOLON(this);
  }
