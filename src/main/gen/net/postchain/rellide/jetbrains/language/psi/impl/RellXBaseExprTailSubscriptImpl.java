...
public class RellXBaseExprTailSubscriptImpl extends ASTWrapperPsiElement implements RellXBaseExprTailSubscript {

  public RellXBaseExprTailSubscriptImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXBaseExprTailSubscript(this);
  }
