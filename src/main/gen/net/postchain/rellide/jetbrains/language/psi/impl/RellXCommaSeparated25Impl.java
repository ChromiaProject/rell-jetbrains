...
public class RellXCommaSeparated25Impl extends ASTWrapperPsiElement implements RellXCommaSeparated25 {

  public RellXCommaSeparated25Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXCommaSeparated25(this);
  }
