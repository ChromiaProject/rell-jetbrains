...
public class RellXAnnotationImpl extends ASTWrapperPsiElement implements RellXAnnotation {

  public RellXAnnotationImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXAnnotation(this);
  }
  ...
  @Override
  @Nullable
  public RellXAnnotationArgs getXAnnotationArgs() {
    return findChildByClass(RellXAnnotationArgs.class);
  }
