...
public class RellXTkRCURLImpl extends ASTWrapperPsiElement implements RellXTkRCURL {

  public RellXTkRCURLImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXTkRCURL(this);
  }
