...
public class RellXCreateStmtImpl extends ASTWrapperPsiElement implements RellXCreateStmt {

  public RellXCreateStmtImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXCreateStmt(this);
  }
  ...
  public RellXCreateExpr getXCreateExpr() {
    return findNotNullChildByClass(RellXCreateExpr.class);
  }
