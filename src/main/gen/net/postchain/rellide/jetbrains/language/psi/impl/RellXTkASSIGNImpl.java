...
public class RellXTkASSIGNImpl extends ASTWrapperPsiElement implements RellXTkASSIGN {

  public RellXTkASSIGNImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXTkASSIGN(this);
  }
