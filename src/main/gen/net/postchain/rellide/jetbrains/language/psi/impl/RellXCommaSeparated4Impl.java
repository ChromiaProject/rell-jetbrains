...
public class RellXCommaSeparated4Impl extends ASTWrapperPsiElement implements RellXCommaSeparated4 {

  public RellXCommaSeparated4Impl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXCommaSeparated4(this);
  }
