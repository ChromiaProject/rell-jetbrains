...
public class RellXDollarExprImpl extends ASTWrapperPsiElement implements RellXDollarExpr {

  public RellXDollarExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXDollarExpr(this);
  }
