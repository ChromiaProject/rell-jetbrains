...
public class RellXNonEmptyMapLiteralExprImpl extends ASTWrapperPsiElement implements RellXNonEmptyMapLiteralExpr {

  public RellXNonEmptyMapLiteralExprImpl(@NotNull ASTNode node) {
    super(node);
  }

  public void accept(@NotNull RellVisitor visitor) {
    visitor.visitXNonEmptyMapLiteralExpr(this);
  }
